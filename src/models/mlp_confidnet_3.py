...
def train(model,epoch, best_ape):
    ...
    if ap_errors>best_ape:
        ...
        best_ape = ap_errors
        torch.save(model.state_dict(), f"../saved_models/mlp_confidence_3.pt")
    return best_ape
...
if __name__ == '__main__':
    ...
    if args.test:
        model.load_state_dict(torch.load('../saved_models/mlp_confidence_3.pt'))
        test(model)